...
class ConversationAgent:
            ...
            FunctionDeclaration(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "carb_budget": {
                            "type": "integer",
                            "description": "Carbohydrate budget for this meal in grams"
                        }
                    },
                    "required": ["meal_type"]
                }
    ...
    def start_conversation(self, health_metrics: HealthMetrics) -> None:
        ...
        self.chat = self.model.start_chat(history=[
            ...
            {"role": "model", "parts": ["Understood! I will recommend suitable meals based on your nutritional targets. What would you like to eat today?"]}
        ])
    ...
    async def process_message(self, user_message: str) -> Dict[str, Any]:
        ...
        if self.chat is None:
            return {
                "type": "error",
                "message": "Conversation not started. Please register first."
            }
